class Ability
  ...
  def initialize(user)
    ...
    if user.user_group.name == "Administrator"
      ...
      # =================== Manager =======================
      can :read, [Labor, Position, PlantingProject, MachineryType, Machinery, EquipmentType, Equipment, ProductionAdjustment, WarehouseProductionAmount, StockIn, WarehouseItemTransaction, InputTask, OutputTask, Farm, Block, PlanFarm, ProductionPlan] if user.user_group.name == "Manager"
