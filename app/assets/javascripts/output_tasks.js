  ...
  $('.block_id').change(function() {
    ...
    jQuery.ajax({
      ...
      success: function(data){
        ...
        // // Get data for Chosen when Planting project has data (From Map)
        // $('select.select-machinaries').html('');
        // var planting_project_id = $(".planting_pro_id").val();
        // jQuery.ajax({
        //   url: "/get_machinery_data",
        //   type: "GET",
        //   data: {"planting_project_id" : planting_project_id},
        ...
        //     if(data.length){
        //       $.each(data, function(i, value) {
        //         $('select.select-machinaries').append('<option value="'+value.uuid+'">'+value.name+'</option>');
        //       });
        //       $('select.select-machinaries').attr("multiple", "multiple");
        //       $('select.select-machinaries').attr("data-placeholder", "Select some items");
        //     }
        //     else{
        //       $('select.select-machinaries').attr("data-placeholder", "No Items");
        //       $('select.select-machinaries').attr("multiple", "multiple");
        //     }
        //     $('select.item-select-machinaries').trigger('chosen:updated');
        //   },
