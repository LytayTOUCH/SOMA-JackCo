 ...
 */
 ...
 // Add with script below(Add script to avoid Error for any browsers)
 jQuery.browser = {};
 // Finished Add

(function($) {
    // Add script to avoid Error for any browsers 
    ...
    $.printPreview = {
        loadPrintPreview: function() {
            // Declare DOM objects
            print_content = $('#report').length > 0 ? $('#report') : $('table.display > *:not(#print-modal):not(script)'); //Added by Derick D'souza on June 27, 2012 to allow filtered printing
